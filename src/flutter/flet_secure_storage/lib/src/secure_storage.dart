...
class SecureStorageService extends FletService {
  ...
  void init() {
    ...
    _storage = const FlutterSecureStorage(
        aOptions: AndroidOptions(
            // TODO: This will be removed in the next version and will default to true.
  ...
  Future<dynamic> _invokeMethod(String name, dynamic args) async {
    switch (name) {
      case "set": // SharedPreferences / client_storage returns bool
      ...
      // TODO: get all keys with the same prefix
      // case "get_keys":
      //   return _storage.containsKey().where((key) => key.startsWith(args["key_prefix"]!)).toList();

      case "remove":
        await _storage.delete(key: args["key"]!);
        return true;

      case "clear": // SharedPreferences / client_storage returns bool
